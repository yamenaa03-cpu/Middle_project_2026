...
/**
 * CheckoutPayController handles the payment process for reservations.
 * 
 * <p>This controller manages the checkout screen where customers can view
 * their bill and complete payment for their dining experience.
 * 
 * <p>Features:
 * <ul>
 *   <li>Display reservations ready for checkout</li>
 *   <li>Load bill details for selected reservation</li>
 *   <li>Show amount before discount and final amount</li>
 *   <li>Process payment confirmation</li>
 * </ul>
 * 
 * <p>Supports both guest flow (via confirmation code) and subscriber flow
 * (via logged-in session).
 * 
 * @author G22 Team
 * @version 1.0
 * @see CheckoutGuestController
