...
/**
 * ClientFrameController provides a debug/admin interface for the client application.
 * 
 * <p>This controller acts as a development and testing interface, implementing
 * {@link ClientUI} to receive server responses. It provides direct access to
 * server operations without going through the main customer UI.
 * 
 * <p>Features:
 * <ul>
 *   <li><b>Connection Management</b> - Manual IP/port configuration and connect</li>
 *   <li><b>Reservations Table</b> - View all reservations with details</li>
 *   <li><b>Direct Updates</b> - Update reservation date/guests directly</li>
 *   <li><b>Message Log</b> - Display all server messages and responses</li>
 * </ul>
 * 
 * <p>Table Columns Displayed:
 * <ul>
 *   <li>Reservation ID, Date/Time, Guests, Confirmation Code</li>
 *   <li>Customer ID, Created At timestamp</li>
 * </ul>
 * 
 * <p>This controller is primarily used for development and debugging purposes.
 * Production users should use the main {@link ClientController} interface.
 * 
 * @author G22 Team
 * @version 1.0
 * @see Client
...
public class ClientFrameController implements ClientUI {
        ...
        @FXML
        private TableColumn<Reservation, Integer> colNumber;
        @FXML
        private TableColumn<Reservation, String> colDate;
        @FXML
        private TableColumn<Reservation, Integer> colGuests;
        @FXML
        private TableColumn<Reservation, Integer> colConf;
        @FXML
        private TableColumn<Reservation, Integer> colSub;
        @FXML
        private TableColumn<Reservation, String> colCreated;

        @FXML
        private TextField updateReservationField;
        @FXML
        private TextField updateDateField;
        @FXML
        private TextField updateGuestsField;

        @FXML
        private TextArea messageArea;

        /**
         * Initialization Called automatically when the GUI loads
         */
        @FXML
        public void initialize() {
                 ...
                 * 
                 * new PropertyValueFactory<>("reservationNumber") Look inside each Reservation
                 * object, Call getReservationNumber() and Puts that value in the column cell
                 */
        ...
        public void onUpdate() {
                ...
                try {
                        ...
                        LocalDateTime newDateTime = LocalDateTime.parse(updateDateField.getText().trim(), formatter);
        ...
        public void displayMessage(String msg) {
                Platform.runLater(() -> messageArea.appendText("[SERVER] " + msg + "\n"));
        }
