...
//      private static final String PASSWORD = "Yabuahmad_782003";
	...
	public List<common.dto.Report.TimeReportEntry> getTimeReportForMonth(int year, int month) throws SQLException {
		String sql = """
	...
	public List<common.dto.Report.SubscriberReportEntry> getSubscriberReportForMonth(int year, int month)
			throws SQLException {
		String sql = """
