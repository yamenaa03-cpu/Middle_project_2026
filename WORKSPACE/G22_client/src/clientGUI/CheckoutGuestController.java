...
/**
 * CheckoutGuestController handles the checkout initiation for guests.
 * 
 * <p>This controller manages the popup where guests can enter their
 * confirmation code to access the payment/checkout screen.
 * 
 * <p>Responsibilities:
 * <ul>
 *   <li>Accept confirmation code input</li>
 *   <li>Look up reservations ready for checkout</li>
 *   <li>Navigate to payment screen on success</li>
 * </ul>
 * 
 * @author G22 Team
 * @version 1.0
 * @see CheckoutPayController
