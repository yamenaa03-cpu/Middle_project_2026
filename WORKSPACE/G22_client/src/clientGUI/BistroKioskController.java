...
/**
 * BistroKioskController manages the kiosk interface for walk-in customers.
 * 
 * <p>This controller provides a touch-friendly interface for customers at
 * the restaurant entrance to perform common actions without staff assistance.
 * 
 * <p>Responsibilities:
 * <ul>
 *   <li>Sign in for subscribers</li>
 *   <li>Receive table (check-in for existing reservations)</li>
 *   <li>Join waiting list (guests and subscribers)</li>
 *   <li>Access payment/checkout</li>
 *   <li>Cancel reservations</li>
 * </ul>
 * 
 * <p>The controller supports both guest and subscriber flows, opening
 * different popup dialogs based on login status.
 * 
 * @author G22 Team
 * @version 1.0
 * @see ClientController
 * @see JoinWaitlistController
...
public class BistroKioskController {
    ...
    /** Flag to track if on-screen keyboard has been opened */
    ...
    /** Reference to active join waitlist controller */
        private JoinWaitlistController JWLC;
        
    /** Reference to active receive table controller */
        private ReceiveTableController RTC;
        
    /** Reference to active receive table confirmation controller */
