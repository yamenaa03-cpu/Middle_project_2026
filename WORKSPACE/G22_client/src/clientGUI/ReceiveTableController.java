...
/**
 * ReceiveTableController handles the table check-in process for guests.
 * 
 * <p>This controller manages the popup where guests can enter their
 * confirmation code to check in and receive their assigned table.
 * 
 * <p>Responsibilities:
 * <ul>
 *   <li>Accept confirmation code input</li>
 *   <li>Validate reservation is receivable</li>
 *   <li>Navigate to confirmation screen on success</li>
 *   <li>Provide forgot code functionality</li>
 * </ul>
 * 
 * @author G22 Team
 * @version 1.0
 * @see ReceiveTableConfirmationController
