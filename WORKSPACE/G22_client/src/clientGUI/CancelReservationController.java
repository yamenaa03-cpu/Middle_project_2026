...
/**
 * CancelReservationController handles the reservation cancellation flow for guests.
 * 
 * <p>This controller manages the popup where guests can enter their confirmation
 * code to look up and cancel an existing reservation.
 * 
 * <p>Responsibilities:
 * <ul>
 *   <li>Accept confirmation code input</li>
 *   <li>Look up cancellable reservations</li>
 *   <li>Navigate to confirmation screen</li>
 *   <li>Provide forgot code functionality</li>
 * </ul>
 * 
 * @author G22 Team
 * @version 1.0
 * @see CancelReservationConfirmController
 * @see ForgotConfirmationCodeController
 */
