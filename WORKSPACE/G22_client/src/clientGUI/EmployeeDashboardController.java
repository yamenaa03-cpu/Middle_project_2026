...
/**
 * EmployeeDashboardController provides the staff management interface.
 * 
 * <p>This comprehensive controller handles all employee/staff operations
 * through a tabbed interface. Sends requests to server via OCSF Client
 * and receives responses via handleServerMessage().
 * 
 * <p>Dashboard Tabs:
 * <ul>
 *   <li><b>Waiting List</b> - View and manage customers waiting for tables</li>
 *   <li><b>Reservations</b> - Search, filter, and manage all reservations</li>
 *   <li><b>Diners Now</b> - View currently seated customers</li>
 *   <li><b>Tables</b> - Add, update, delete table configurations</li>
 *   <li><b>Working Hours</b> - Configure restaurant opening/closing times</li>
 *   <li><b>Members</b> - Search and view subscriber information</li>
 *   <li><b>On Behalf</b> - Perform operations for customers (reservations, cancel, receive, checkout)</li>
 * </ul>
 * 
 * <p>On Behalf Features:
 * <ul>
 *   <li>Find customer by code, phone, or email</li>
 *   <li>Make reservations on behalf of customers</li>
 *   <li>Join waitlist for customers or guests</li>
 *   <li>Cancel reservations</li>
 *   <li>Receive table (check-in)</li>
 *   <li>Process checkout and payment</li>
 * </ul>
 * 
 * @author G22 Team
 * @version 1.0
...
public class EmployeeDashboardController {
        ...
        // ================= WAITING LIST =================
        @FXML
        private Button btnRefreshWaitingList;
        @FXML
        private ChoiceBox<String> waitingStatusFilter;

        @FXML
        private TableView<Reservation> waitingTable;
        @FXML
        private TableColumn<Reservation, String> colWaitId;
        @FXML
        private TableColumn<Reservation, String> colWaitCustomer;
        @FXML
        private TableColumn<Reservation, String> colWaitGuests;
        @FXML
        private TableColumn<Reservation, String> colWaitTime;
        @FXML
        private TableColumn<Reservation, String> colWaitStatus;
        @FXML
        private TableColumn<Reservation, String> colWaitNotes;
        ...
        @FXML
        private ChoiceBox<String> reservationStatusFilter;
        @FXML
        ...
        @FXML
        private TableColumn<Reservation, String> colResDateTime;
        @FXML
        private TableColumn<Reservation, String> colResGuests;
        @FXML
        private TableColumn<Reservation, String> colResConf;
        @FXML
        private TableColumn<Reservation, String> colResCustomerId;
        @FXML
        private TableColumn<Reservation, String> colResTableId;
        @FXML
        private TableColumn<Reservation, String> colResStatus;
        @FXML
        private TableColumn<Reservation, String> colResCreated;

        // ================= DINERS NOW =================
        @FXML
        private Button btnRefreshDinersNow;
        @FXML
        private Label lblDinersNowStatus;

        @FXML
        private TableView<Customer> dinersNowTable; // server returns List<Customer>
        @FXML
        private TableColumn<Customer, String> colDinerResId;
        @FXML
        private TableColumn<Customer, String> colDinerCustomer;
        @FXML
        private TableColumn<Customer, String> colDinerGuests;
        @FXML
        private TableColumn<Customer, String> colDinerTableId;
        @FXML
        private TableColumn<Customer, String> colDinerStatus;
        @FXML
        private TableColumn<Customer, String> colDinerSince;

        // ================= TABLES =================
        @FXML
        private Button btnRefreshTables;
        @FXML
        private Label lblSelectedTableId;
        @FXML
        private Label lblTablesMsg;

        @FXML
        private TextField tableCapacityField;
        @FXML
        private Button btnAddTable;
        @FXML
        private Button btnUpdateTableCapacity;
        @FXML
        private Button btnDeleteTable;

        @FXML
        private FlowPane tablesGraphPane;
        @FXML
        private TableView<Table> tablesTable;
        @FXML
        private TableColumn<Table, String> colTableId;
        @FXML
        private TableColumn<Table, String> colCapacity;

        private Table selectedTable = null;

        // ================= WORKING HOURS =================
        @FXML
        private Button btnLoadHours;
        @FXML
        private Button btnSaveHours;

        @FXML
        private TableView<OpeningHours> hoursTable; // rename if needed
        @FXML
        private TableColumn<OpeningHours, String> colDay;
        @FXML
        private TableColumn<OpeningHours, String> colOpen;
        @FXML
        private TableColumn<OpeningHours, String> colClose;
        @FXML
        private TableColumn<OpeningHours, String> colClosed;
        ...
        @FXML
        private TableView<Customer> membersTable;
        @FXML
        ...
        @FXML
        private TableColumn<Customer, String> colCustSubscribed;
        @FXML
        private TableColumn<Customer, String> colCustCode;

        // ================= ON BEHALF - FIND CUSTOMER =================
        @FXML
        private RadioButton rbFindByCode;
        @FXML
        private RadioButton rbFindByPhone;
        @FXML
        private RadioButton rbFindByEmail;

        @FXML
        private TextField tfFindCustomerValue;
        @FXML
        private Button btnFindCustomer;
        @FXML
        private Button btnClearCustomerSearch;
        @FXML
        private Label lblFindCustomerStatus;

        @FXML
        private TableView<Customer> customerSearchResultsTable;
        @FXML
        private TableColumn<Customer, String> colFoundCustId;
        @FXML
        private TableColumn<Customer, String> colFoundCustName;
        @FXML
        private TableColumn<Customer, String> colFoundCustPhone;
        @FXML
        private TableColumn<Customer, String> colFoundCustEmail;
        @FXML
        private TableColumn<Customer, String> colFoundCustCode;

        @FXML
        private Button btnSelectCustomerFromResults;
        @FXML
        private Button btnUnselectCustomer;
        @FXML
        private Label lblSelectedCustomer;
        @FXML
        private Label lblOnBehalfGlobalStatus;
        @FXML
        private Label lblSelectedCustomerIdHidden;

        private Customer selectedCustomer = null;

        // ================= ON BEHALF - MAKE RESERVATION =================
        @FXML
        private DatePicker dpMakeResDate;
        @FXML
        private ComboBox<String> cbMakeResHour;
        @FXML
        private ComboBox<String> cbMakeResMinute;
        @FXML
        private Spinner<Integer> spMakeResGuests;

        @FXML
        private CheckBox cbMakeResGuestMode;
        @FXML
        private TextField tfMakeResGuestName;
        @FXML
        private TextField tfMakeResGuestPhone;
        @FXML
        private TextField tfMakeResGuestEmail;

        @FXML
        private Button btnMakeReservationOnBehalf;
        @FXML
        private Label lblMakeReservationStatus;

        // ================= ON BEHALF - JOIN WAITLIST =================
        @FXML
        private Spinner<Integer> spWaitlistGuests;
        @FXML
        private CheckBox cbWaitlistGuestMode;
        @FXML
        private TextField tfWaitlistGuestName;
        @FXML
        private TextField tfWaitlistGuestPhone;
        @FXML
        private TextField tfWaitlistGuestEmail;
        @FXML
        private Button btnJoinWaitlistOnBehalf;
        @FXML
        private Label lblJoinWaitlistStatus;

        // ================= ON BEHALF - CANCEL =================
        @FXML
        private Button btnLoadCancelableReservations;
        @FXML
        private Label lblCancelLoadStatus;
        @FXML
        private TableView<Reservation> cancelReservationsTable;
        @FXML
        private TableColumn<Reservation, String> colCancelResId;
        @FXML
        private TableColumn<Reservation, String> colCancelDateTime;
        @FXML
        private TableColumn<Reservation, String> colCancelGuests;
        @FXML
        private TableColumn<Reservation, String> colCancelStatus;
        @FXML
        private TableColumn<Reservation, String> colCancelConf;
        @FXML
        private Button btnCancelSelectedReservation;
        @FXML
        private Label lblCancelStatus;

        // ================= ON BEHALF - RECEIVE =================
        @FXML
        private Button btnLoadReceivableReservations;
        @FXML
        private Label lblReceiveLoadStatus;
        @FXML
        private TableView<Reservation> receiveReservationsTable;
        @FXML
        private TableColumn<Reservation, String> colReceiveResId;
        @FXML
        private TableColumn<Reservation, String> colReceiveDateTime;
        @FXML
        private TableColumn<Reservation, String> colReceiveGuests;
        @FXML
        private TableColumn<Reservation, String> colReceiveStatus;
        @FXML
        private TableColumn<Reservation, String> colReceiveConf;
        @FXML
        private Button btnReceiveTableForSelected;
        @FXML
        private Label lblReceiveStatus;

        // ================= ON BEHALF - CHECKOUT =================
        @FXML
        private Button btnLoadCheckoutReservations;
        @FXML
        private Label lblCheckoutLoadStatus;
        @FXML
        private TableView<Reservation> checkoutReservationsTable;
        @FXML
        private TableColumn<Reservation, String> colCheckoutResId;
        @FXML
        private TableColumn<Reservation, String> colCheckoutDateTime;
        @FXML
        private TableColumn<Reservation, String> colCheckoutGuests;
        @FXML
        private TableColumn<Reservation, String> colCheckoutStatus;
        @FXML
        private TableColumn<Reservation, String> colCheckoutConf;

        @FXML
        private Button btnLoadBillForSelected;
        @FXML
        private Button btnPayLoadedBill;
        @FXML
        private Label lblCheckoutStatus;
        @FXML
        private TextArea taBillDetails;
        ...
        private void initialize() {
                ...
                reservationStatusFilter.setItems(
                                FXCollections.observableArrayList("All", "ACTIVE", "WAITING", "SEATED", "CANCELLED", "COMPLETED"));
                reservationStatusFilter.setValue("All");
                reservationStatusFilter.getSelectionModel().selectedItemProperty()
                                .addListener((o, a, b) -> applyReservationsFilter());
                ...
                cbMakeResHour.setItems(FXCollections.observableArrayList("08", "09", "10", "11", "12", "13", "14", "15", "16",
                ...
                colDinerCustomer
                                .setCellValueFactory(c -> new SimpleStringProperty(safeStr(c.getValue(), "getFullName", "Unknown")));
                colDinerResId.setCellValueFactory(
                                c -> new SimpleStringProperty(safeStr(c.getValue(), "getCurrentReservationId", "")));
                colDinerGuests
                                .setCellValueFactory(c -> new SimpleStringProperty(safeStr(c.getValue(), "getCurrentGuests", "")));
                colDinerTableId
                                .setCellValueFactory(c -> new SimpleStringProperty(safeStr(c.getValue(), "getCurrentTableId", "")));
                colDinerStatus
                                .setCellValueFactory(c -> new SimpleStringProperty(safeStr(c.getValue(), "getCurrentStatus", "")));
                colDinerSince.setCellValueFactory(c -> new SimpleStringProperty(safeStr(c.getValue(), "getDiningSince", "")));
                ...
                colCustSubscribed
                                .setCellValueFactory(c -> new SimpleStringProperty(String.valueOf(c.getValue().isSubscriber())));
                ...
                setupSmallReservationTable(cancelReservationsTable, colCancelResId, colCancelDateTime, colCancelGuests,
                                colCancelStatus, colCancelConf);
                setupSmallReservationTable(receiveReservationsTable, colReceiveResId, colReceiveDateTime, colReceiveGuests,
                                colReceiveStatus, colReceiveConf);
                setupSmallReservationTable(checkoutReservationsTable, colCheckoutResId, colCheckoutDateTime, colCheckoutGuests,
                                colCheckoutStatus, colCheckoutConf);
        ...
        private void setupReservationColumns(TableView<Reservation> tv, TableColumn<Reservation, String> colId,
                        TableColumn<Reservation, String> colGuests, TableColumn<Reservation, String> colStatus,
                ...
                colDtOrTime.setCellValueFactory(c -> {
                        ...
                        if (dt == null || dt.isBlank())
                                dt = safeStr(c.getValue(), "getCreatedAt", "");
                        return new SimpleStringProperty(dt);
                });
        }

        private void setupSmallReservationTable(TableView<Reservation> tv, TableColumn<Reservation, String> colId,
                        TableColumn<Reservation, String> colDateTime, TableColumn<Reservation, String> colGuests,
                        TableColumn<Reservation, String> colStatus, TableColumn<Reservation, String> colConf) {
                colId.setCellValueFactory(c -> new SimpleStringProperty(safeStr(c.getValue(), "getReservationId", "")));
                colDateTime.setCellValueFactory(
                                c -> new SimpleStringProperty(safeStr(c.getValue(), "getReservationDateTime", "")));
                colGuests.setCellValueFactory(c -> new SimpleStringProperty(safeStr(c.getValue(), "getNumberOfGuests", "")));
                colStatus.setCellValueFactory(c -> new SimpleStringProperty(safeStr(c.getValue(), "getStatus", "")));
        ...
        private void applyWaitingFilter() {
                String filter = waitingStatusFilter.getValue();
                if (filter == null || filter.equals("All")) {
                        waitingTable.setItems(waitingList);
                        return;
                }

                waitingTable.setItems(waitingList.filtered(r -> filter.equalsIgnoreCase(safeStr(r, "getStatus", ""))));
        }
        ...
        private void applyReservationsFilter() {
                String filter = reservationStatusFilter.getValue();
                if (filter == null || filter.equals("All")) {
                        reservationTable.setItems(reservationsList);
                        return;
                }

                reservationTable.setItems(reservationsList.filtered(r -> filter.equalsIgnoreCase(safeStr(r, "getStatus", ""))));
        }
        ...
        private void searchReservationsLocal() {
                ...
                ObservableList<Reservation> filtered = reservationsList.filtered(
                                r -> safeStr(r, "getReservationId", "").contains(q) || safeStr(r, "getConfirmationCode", "").contains(q)
        ...
        private LocalTime parseLocalTimeFlexible(String s) {
                ...
                try {
                        if (s.length() >= 5)
                                return LocalTime.parse(s.substring(0, 5)); // 08:30
                } catch (Exception ignored) {
                }
        ...
        private void searchMembersLocal() {
                ...
                ObservableList<Customer> filtered = membersList.filtered(c -> String.valueOf(c.getCustomerId()).contains(q)
        ...
        private void makeReservationOnBehalf() {
                ...
                client.createCreateReservationOnBehalfRequest(selectedCustomer.getCustomerId(), dt, guests);
        ...
        private void joinWaitlistOnBehalf() {
                ...
                client.createJoinWaitlistOnBehalfRequest(selectedCustomer.getCustomerId(), guests);
        ...
        private void loadCancelableReservations() {
                ...
                client.createGetCancellableReservationsOnBehalfRequest(selectedCustomer.getCustomerId());
        ...
        private void cancelSelectedReservation() {
                ...
                client.createCancelReservationOnBehalfRequest(selectedCustomer.getCustomerId(), r.getReservationId());
        ...
        private void loadReceivableReservations() {
                ...
                client.createGetReceivableReservationsOnBehalfRequest(selectedCustomer.getCustomerId());
        ...
        private void receiveTableForSelected() {
                ...
                client.createReceiveTableOnBehalfRequest(selectedCustomer.getCustomerId(), r.getReservationId());
        ...
        private void loadCheckoutReservations() {
                ...
                client.createGetPayableReservationsOnBehalfRequest(selectedCustomer.getCustomerId());
        ...
        private void loadBillForSelected() {
                ...
                client.createGetBillForPayingOnBehalfRequest(selectedCustomer.getCustomerId(), r.getReservationId());
        ...
        private void payLoadedBill() {
                ...
                client.createPayBillOnBehalfRequest(selectedCustomer.getCustomerId(), loadedBillId);
        ...
        /**
         * safeStr(obj,"getX","fallback") uses reflection so controller doesn't crash if
         * your entity uses slightly different getter names.
         */
