 ...
 *
 * This class is the JavaFX controller for the Client GUI. It acts as the "view
 * controller" that: - Reads user actions from the GUI - Sends requests to the
 * Client - Updates the interface with server responses
 *
 * It implements ClientUI meaning the server can communicate with the GUI
 * through displayMessage() and displayReservations().
 *
 * @version 1.0
 */
