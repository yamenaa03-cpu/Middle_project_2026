...
/**
 * JoinWaitlistController handles the join waitlist functionality.
 * 
 * <p>This controller manages the popup where customers can join the
 * waiting list when no tables are immediately available.
 * 
 * <p>Supports both guest and subscriber flows:
 * <ul>
 *   <li>Guests must provide name, phone, and email</li>
 *   <li>Subscribers only need to specify party size</li>
 * </ul>
 * 
 * @author G22 Team
 * @version 1.0
 * @see BistroKioskController
...
public class JoinWaitlistController {
    ...
    /** Reference to parent kiosk controller */
