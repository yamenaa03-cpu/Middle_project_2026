...
/**
 * PersonalSpaceController manages the subscriber's personal dashboard.
 * 
 * <p>This controller provides subscribers with a comprehensive view of their
 * account information, active reservations, and reservation history.
 * 
 * <p>Features:
 * <ul>
 *   <li>View and edit personal information (name, phone, email)</li>
 *   <li>Display membership code and subscription status</li>
 *   <li>View active reservations with cancel option</li>
 *   <li>View reservation history</li>
 *   <li>Leave waiting list functionality</li>
 * </ul>
 * 
 * <p>Active statuses tracked: ACTIVE, NOTIFIED, IN_PROGRESS, WAITING
 * 
 * @author G22 Team
 * @version 1.0
